...
Chicago$outcomes <- read.csv("datasets/chicago.csv") |>
    select(Date = Week.End, Outcome, Age.Group, Population.Unvaccinated, Population.Vaccinated, Population.Boosted, Outcome.Unvaccinated, Outcome.Vaccinated, Outcome.Boosted) |>
    # Sort by date
